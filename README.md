...
> Web application that converts spoken words into accurate text in real-time with multi-language support.

`JavaScript` `HTML` `CSS` `Web Speech API`

<a href="https://github.com/Dheeraj261708/speech-to-text-system">
  <img src="https://raw.githubusercontent.com/Dheeraj261708/speech-to-text-system/main/assets/screenshots/live_transcription.png" width="100%" alt="Speech to Text Preview" />
</a>
